...
class Todo(db.Model):
    ...
    completed : bool = db.Column(db.Boolean, nullable=False, default=False)
     ...
     # This column has a default value and allows nullable
    deadline_at : datetime = db.Column(db.DateTime, nullable=True)

    # This column has a default value which is a function call
    created_at : datetime = db.Column(db.DateTime, nullable=False, default=datetime.datetime.utcnow)

    # This column has a default value which is a function call and also updates on update
    updated_at : datetime = db.Column(db.DateTime, nullable=False, default=datetime.datetime.utcnow, onupdate=datetime.datetime.utcnow)
